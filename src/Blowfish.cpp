...
Blowfish::Blowfish(const std::vector<uint8_t>& key) : Blowfish(key.data(), key.size()) {}

Blowfish::Blowfish(const std::string& key) : Blowfish(reinterpret_cast<const uint8_t*>(key.data()), key.size()) {}
...
void Blowfish::encrypt(uint32_t& left, uint32_t& right) const {
...
void Blowfish::decrypt(uint32_t& left, uint32_t& right) const {
...
std::vector<uint8_t> Blowfish::encrypt(const std::vector<uint8_t>& data) const {
